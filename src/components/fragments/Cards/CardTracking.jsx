    ...
    <div className="card card-compact w-72 bg-putih-0 bg-opacity-5 relative">
      ...
      <div className="card-body gap-y-3">
        <div className='flex flex-col gap-0 mb-2'>
          <h2 className="card-title text-putih-0 font-secondary font-medium">{title}</h2>
          <h3 className='text-gray-400 font-secondary -mt-1'>{days}</h3>
        </div>
        <p className='text-putih-0 font-secondary font-extralight'>{desc}</p>
        <div className="card-actions justify-between flex items-center">
          <h2 className='font-secondary text-putih-0 text-lg font-medium'>USD. {price}</h2>
