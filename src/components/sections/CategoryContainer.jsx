...
const Category = () => {
  ...
  const limitedDataTrekking = DataTracking.slice(0, 5)
  ...
  return (
    <div className="category-container mx-auto text-center w-full flex flex-col">
      <div className="mb-12 xl:mb-12">
        <h1 className="text-putih-0 font-tomorrow text-3xl xl:text-3xl  text-center">Finde Out The Best <br /> Travel Choice in Asia</h1>
